...
class ObjectDataset(mrcnn.utils.Dataset):
    ...
    def load_dataset(self, dataset_dir, is_train=True):
        ...
        self.add_class("dataset", 2, "circle")
...
train_dataset.load_dataset(dataset_dir='object', is_train=True)
train_dataset.prepare()

# Validation
validation_dataset = ObjectDataset()
validation_dataset.load_dataset(dataset_dir='object', is_train=False)
